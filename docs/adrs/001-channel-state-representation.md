...
Because consensus will look in every case the same - just a final balance signed
by both parties the only worth consideration flow which we should analyse is non
consensus closure.
